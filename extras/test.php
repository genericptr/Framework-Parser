...
function parse_directory ($directory) {
	// $GLOBALS["argv"][] = "-frameworks=\"Dispatch\"";
	$GLOBALS["argv"][] = "-dir=\"Dispatch:$directory\"";
	$GLOBALS["argv"][] = "-umbrella=\"$directory/dispatch.h\"";
	$GLOBALS["argv"][] = "-out=\"~/Desktop/".basename($directory)."\"";
	$GLOBALS["argv"][] = "-sdk=MacOSX.sdk";
	$GLOBALS["argv"][] = "-all";
	// $GLOBALS["argv"][] = "-class_definitions";
	$GLOBALS["argv"][] = "-build_skeletons";
	$GLOBALS["argv"][] = "-v+";
